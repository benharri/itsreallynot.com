...
return [
    ...
    'timestamp' => 1523731514,
    'checksum' => '144256b082136e32be35b692cb2e3114',
    'files' => [
        'user/config' => [
            'media' => [
    ...
    'data' => [
        ...
        'site' => [
            ...
            'default_lang' => 'en',
            'author' => [
                'name' => 'it\'s really not',
                'email' => 'apex@itsreallynot.com',
            ...
            'metadata' => [
                'description' => 'Sora Article is a minimal Theme designed for blogger, converted to Grav.'
            ],
            'summary' => [
                'enabled' => true,
                'format' => 'short',
            ...
            'copyright' => [
                'text1' => 'Copyright',
                'year' => 2018,
                'url' => 'http://sora-article-soratemplates.blogspot.in/',
                'text2' => 'Sora Article'
            ],
            'copyright2' => [
                'text1' => ', Ported by',
